...
const Electronicsallsub2 = ({electronicsItems,CartItem,productItems}) => {
  ...
  return (
    ...
    <div className='beddings-container'>
        {electronicsItems.slice(6,11).map((electronicsItems, index) => {
          return (
...
export default Electronicsallsub2
